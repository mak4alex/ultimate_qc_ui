...
/// Number of Images /// images_count( {critical: true})  /// 3       /// patch_count
}

function patch_product_title(etalon, product) {
  return { "et_val": "NONE", "pr_val": "NONE", "comp": true }
}

function patch_find_brand_in_name(etalon, product) {
  return { "et_val": "NONE", "pr_val": "NONE", "comp": true }
}

function patch_count(etalon, product) {
  var et_val = 3
